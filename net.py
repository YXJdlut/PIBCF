...
class CDDFuse(nn.Module):
    def __init__(self, inp_channels=1, out_channels=1, dim=64, num_blocks=[4, 4], 
                 heads=[8, 8, 8], ffn_expansion_factor=2, bias=False, LayerNorm_type='WithBias'):
    ...
    #新：dim== 256
        ...
        self.DetailFuseLayer = DetailFeatureExtraction(num_layers = 3)
    
    def  forward(self,data_IR,data_VIS):
        ...
        # return data_Fuse
        return data_Fuse, None, None, None, None


"""
    这段代码实现了Drop Path功能，用于在训练神经网络时随机丢弃网络中的部分连接，以提高模型的泛化能力和抗过拟合能力
"""
def drop_path(x, drop_prob: float = 0., training: bool = False):
    ...
    return output
#这是一个PyTorch的自定义模块DropPath，用于实现Drop Path功能。Drop Path是一种用于增强深度神经网络的正则化技术，它在训练期间随机丢弃网络中的部分连接，以减少过拟合。
...
#注意力机制的pytorch模块，提取输入特征之间的相关性信息
...
##########################################################################
## Overlapped image patch embedding with 3x3 Conv 新 in_c=3
